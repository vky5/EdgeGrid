// Package joinmgr manages node join requests stored in the NATS KV bucket "join_requests"
package joinmgr
...
func (m *Manager) Approve(nodeID, token, coordURL string) error {
